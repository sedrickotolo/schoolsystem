        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>,Brought &nbsp;<i class="ti-heart heart"></i> &nbsp;To You By <a href="http://www.kakebe.com">KaKebe Technologies LTD</a>
                </div>
            </div>
        </footer>
